  ...
  if (Array.isArray(params) && params.length > 0) {
    for (let i = 0, n = params.length; i < n; i++) {
      if (typeof params[i] === 'number' &&
        params[i] % 1 !== 0) {
        // TODO: prefer decimal or numeric data
        // until https://github.com/loopbackio/loopback-connector-mssql/issues/183 is resolved
        request.input('param' + (i + 1), mssql.Decimal(38, 10), params[i]);
